...
class andy extends commando.Command {
    ...
    async run(message, args) {
        ...
        +"This is a random bot that does random things, some of which include playing random Youtube clips, replying to certain responses, and rolling random responses, all a result of our random server.");
    }
}
